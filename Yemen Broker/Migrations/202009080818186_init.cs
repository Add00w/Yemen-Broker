namespace Yemen_Broker.Migrations
{
    ...
    public partial class init : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        AdLocation = c.String(nullable: false),
                        AdPrice = c.Double(nullable: false),
                        AdDescribtion = c.String(),
                ...
                c => new
                    {
                        ...
                        StreetArea = c.String(maxLength: 200),
                    })
                .PrimaryKey(t => t.AdId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Shops", "AdId", "dbo.Ads");
            DropForeignKey("dbo.AspNetUserRoles", "RoleId", "dbo.AspNetRoles");
            DropIndex("dbo.AspNetUserLogins", new[] { "UserId" });
            DropIndex("dbo.AspNetUserClaims", new[] { "UserId" });
            DropIndex("dbo.AspNetUsers", "UserNameIndex");
            DropIndex("dbo.Shops", new[] { "AdId" });
